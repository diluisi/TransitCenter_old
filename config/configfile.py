...
#*****************************************************************************
    ...
    def write_default_config(self, region_list=REGIONS_DEFAULT):
        ...
        for REGION in region_list:
            ...
            # Open Street Map
            config[REGION]['osm'] = '../data/' + REGION + '/input/osm_data/'   
            # Population data
            config[REGION]['population_data'] = '../data/' + REGION + '/input/population_data/'   
            # Destination data
            config[REGION]['destination_data'] = '../data/' + REGION + '/input/destination_data/destination_employment_lehd.csv'   
            # GTFS
            config[REGION]['gtfs_static'] = '../data/' + REGION + '/input/gtfs/gtfs_static'
            config[REGION]['gtfs_rt'] = '../data/' + REGION + '/input/gtfs/gtfs_realtimes'   
            # Output
            config[REGION]['accessibility'] = '../data/' + REGION + '/input/output/accessibility_calc_output'
            config[REGION]['equity'] = '../data/' + REGION + '/input/output/equity_calc_output'
            config[REGION]['fare'] = '../data/' + REGION + '/input/output/fare_calc_output'
            config[REGION]['reliability'] = '../data/' + REGION + '/input/output/fare_calc_output'
            config[REGION]['service'] = '../data/' + REGION + '/input/output/servicehours_calc_output'   
            # OTP
            config[REGION]['graphs'] = '../data/' + REGION + '/otp/graphs'  
            config[REGION]['itinerary'] = '../data/' + REGION + '/otp/itinerary'     
